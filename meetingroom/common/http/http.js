...
const api = process.env.NODE_ENV === 'development' ? "http://172.16.0.125:14054/api/meetingroomapp/" :
	"http://172.16.0.125:14054/api/meetingroomapp/"
const socketUrl = process.env.NODE_ENV === 'development' ? "ws://172.16.0.125:14054/websocket/" :
	"ws://172.16.0.125:14054/websocket/"
 const imgsUrl = "http://172.16.0.125:14054/"
const self = this
