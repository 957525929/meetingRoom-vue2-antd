      ...
      <a-row type="flex" align="middle">
        ...
        <a-col>
          <a-cascader style="width: 300px" :options="selectOptions" @click="handlePlaceTree" placeholder="请选择位置"
            v-model="queryParam.place" :display-render="displayRender" />
        </a-col>
        <a-col :span="1"></a-col>
        <a-col>
          <span>房间号：</span>
      ...
      <a-form-model ref="ruleForm" :model="formAdd" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-model-item ref="placeName" label="位置" prop="placeName">
          <a-cascader style="width: 410px" :options="selectOptions" v-model="formAdd.placeName" placeholder="请选择位置"
            :display-render="displayRenderAdd" @click="handlePlaceTree" />
        </a-form-model-item>
    ...
    <a-drawer :visible="visibleModify" title="修改会议室信息" @close="modifyClose" width="600px" placement="right">
      <a-form-model ref="ruleForm" :model="formModify" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-model-item label="位置" prop="placeName">
          <a-cascader style="width: 410px" :options="selectOptions" placeholder="请选择位置"
            :display-render="displayRenderModify" @click="handlePlaceTree" v-model="formModify.placeName" />
        </a-form-model-item>
