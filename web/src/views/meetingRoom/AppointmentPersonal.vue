  ...
  <a-card :bordered="false">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="2">
              ...
              <div class="bgc">
                <a-date-picker placeholder="请选择会议时间" :style="{ width: '430px' }" :format="dateFormat"
          ...
          <tr>
            <td colspan="2">
              ...
              <div class="bgc">
                <a-cascader :options="optionsRoom" placeholder="请选择会议室" v-model="meetingRoom" @change="onChangeRoom"
                  style="width: 425px" :display-render="displayRender" />
              </div>
            </td>
            <td colspan="2">
          ...
          <tr>
            <td colspan="4">
              ...
              <div class="bgc">
                <a-textarea v-model="meetingComments" placeholder="请输入会议备注信息" :auto-size="{ minRows: 3, maxRows: 5 }"
                  :style="{ width: '80%' }" />
              </div>
            </td>
          </tr>
    ...
    <a-modal v-model="visibleReason" title="强制预约原因" @ok="handleOkReason" @cancel="handleCancelReason">
      <a-row type="flex" align="middle">
        ...
        <a-clo>
          <a-textarea placeholder="请输入强制预约原因" :auto-size="{ minRows: 3, maxRows: 5 }" :style="{ width: '400px' }" />
        </a-clo>
      </a-row>
    </a-modal>
