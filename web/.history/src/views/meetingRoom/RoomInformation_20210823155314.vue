  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-row type="flex" align="middle">
        ...
        <a-col>
          <a-cascader style="width: 300px" :options="selectOptions" change-on-select @change="handlePlaceTree" @click="handlePlaceTree"
...
export default {
    ...
    methods: {
        ...
        handlePlaceTree() {
            ...
            if (areaData[0].children[0].children[0].children.length == 0) {
                for (let i = 0; i < this.placeTreeTwo.length; i++) {
                    areaData[0].children[0].children[0].children.push({
             ...
             if (areaData[0].children[0].children[1].children.length == 0) {
                for (let i = 0; i < this.placeTreeTwo2.length; i++) {
                    areaData[0].children[0].children[1].children.push({
             ...
             if (areaData[0].children[0].children[2].children.length == 0) {
                for (let i = 0; i < this.placeTreeTwo3.length; i++) {
                    areaData[0].children[0].children[2].children.push({
             ...
             if (areaData[0].children[0].children[3].children.length == 0) {
                for (let i = 0; i < this.placeTreeTwo4.length; i++) {
                    areaData[0].children[0].children[3].children.push({
            ...
            if (areaData[0].children[1].children[0].children.length == 0) {
                for (let i = 0; i < this.placeTreeTwo1.length; i++) {
                    areaData[0].children[1].children[0].children.push({
                        label: this.placeTreeTwo1[i].placeName,
                        value: this.placeTreeTwo1[i].placeName,
                    })
                }
            }
            console.log(areaData[0].children[1].children[0].children)
        },
    },
}
</script>
