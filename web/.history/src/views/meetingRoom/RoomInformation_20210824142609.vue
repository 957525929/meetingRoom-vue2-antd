...
import { addMeetingRoom } from '@/api/meeting'
...
export default {
  ...
  methods: {
    ...
    onSubmitAdd() {
      ...
      console.log(this.formAdd.placeName.join('.'))
      ...
      this.handleFormAddData.push({
        ...
        whiteboard:this.formAdd.meetingroomId
        meetingRoomSize: this.formAdd.meetingRoomSize,
        placeName: this.formAdd.placeName.join('.')
      })
      console.log('处理数组')
      console.log(this.checkedValuesData)
      console.log(this.handleFormAddData)
      // console.log(this.formAdd.blackboard)
    },
    resetFormAdd() {
