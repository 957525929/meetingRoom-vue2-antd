...
<script>
  ...
  import { placeTree } from '@/api/meeting'
  const dataRoom = [{
      index: 1,
  ...
  export default {
    ...
    methods: {
      ...
      addRoom() {
        ...
        placeTree(eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZWxlcGhvbmUiOiIxODg1OTY5OTM1MSIsImV4cCI6MTYyOTY4ODYxNiwidXNlcklkIjoiMyIsInVzZXJuYW1lIjoidGVzdG1hbjMifQ.8FeW4bhmjDSsGHqWbBRJNVTFLRT5_4QtnA-U3LeIfSU).then(response=>{
