...
// console.log(this.$store)
    ...
    destroyed(){
        // areaData[0].children[0].children=''
    },
    computed:{
        firstTree(){
        ...
        if( areaData[0].children[0].children.length==0){
              for(let i=0;i<this.firstTree.length;i++){
                  areaData[0].children[0].children.push({
                      ...
                      children:this.firstTree[i].placeName,
                  })
              }
        }
      //  if( areaData[0].children[0].children[0]){
        // for(let i=0;i<this.placeTreeTwo.length;i++){
        //     areaData[0].children[0].children[0].push({
        // value:this.firstTree[i].placeName,
        //     })
        // }
      //   console.log('1111212144');
      //  } 
        ...
        // areaData[0].children[0].children[0].push({firstTree1})
        // console.log(areaData[0].children[0].children[0].push(children))     
        console.log(areaData[0].children[0].children);
      }
    },
  }
</script>
