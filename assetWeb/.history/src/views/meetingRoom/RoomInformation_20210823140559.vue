  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-row type="flex" align="middle">
        ...
        <a-col>
          <a-cascader style="width: 300px" :options="selectOptions" change-on-select @change="areaChange" @click="handlePlaceTree"
...
export default {
    ...
    methods: {
        ...
        addRoom() {
            ...
            console.log('111')
            // console.log(this.firestTree)
            console.log(this.handlefirstTree)
        },
        addDutyName(value) {
            if (value == '李霞') {
        ...
        handlePlaceTree() {
            console.log('1111133')
            console.log(this.handleTreeData)
