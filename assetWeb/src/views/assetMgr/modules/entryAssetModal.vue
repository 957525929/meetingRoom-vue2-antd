  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model, 'name', 'assetType', 'deviceName', 'amount', 'price', 'factory',
            'supply', 'payTime ', 'model', 'fundType', 'department', 'campus', 'tower', 'room', 'fundSource',
            'invoice', 'status', 'checkTime', 'statusName'))
        });
        //身份为上级显示负责部门，否则不显示
